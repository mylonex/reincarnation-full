...
const HomePage = () => {
  return (
    <div className="bg-dark-900 text-gray-100 font-sans">
      <Header />
      <section className="py-16 md:py-24 px-6 text-center relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute bottom-10 right-1/4 w-48 h-48 bg-neon-blue rounded-full filter blur-3xl opacity-10 animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
          {/* Исправлено: style как объект */}
          <div
            className="absolute top-1/3 right-1/3 w-32 h-32 bg-neon-green rounded-full filter blur-3xl opacity-10 animate-float"
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6">
            ...
            себя <br />
            как персонажа в игре
          </h1>
          <p className="text-lg md:text-xl text-gray-400 mb-8 leading-relaxed max-w-3xl mx-auto">
            Учи английский, программирование, дизайн и рисование через игровые
            квесты. Зарабатывай опыт, открывай достижения и становись лучшей
            версией себя!
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/auth"
              className="bg-gradient-to-r from-neon-pink to-neon-purple hover:from-neon-purple hover:to-neon-blue text-white font-bold px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-neon-pink/50"
            >
              Начать игру
            </a>
            <a
              href="#skills"
              className="border-2 border-neon-blue text-neon-blue hover:bg-neon-blue/10 px-8 py-4 rounded-lg font-bold transition-all duration-300"
            >
              Выбрать навык
            </a>
          </div>
              ...
              <div className="absolute inset-2 bg-dark-800 rounded-xl border-2 border-neon-purple/50 flex items-center justify-center rotate-0 overflow-hidden">
                ...
                <div className="relative z-10 p-4">
                  <div className="bg-dark-900/90 backdrop-blur-sm rounded-lg p-4 border border-neon-green/50">
                    ...
                    <p className="text-xs mt-1 text-neon-green">
                      +150 XP за прохождение
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Выбери направление развития и начни зарабатывать опыт прямо сейчас
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="bg-dark-700 p-6 rounded-xl border-2 border-neon-blue/20 hover:border-neon-blue/50 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-bold text-center mb-3 text-neon-blue">
                Английский
              </h3>
              <p className="text-gray-400 text-center mb-4">
                Изучай язык через игры, сериалы и общение с носителями
              </p>
            ...
            <div className="bg-dark-700 p-6 rounded-xl border-2 border-neon-green/20 hover:border-neon-green/50 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-bold text-center mb-3 text-neon-green">
                Программирование
              </h3>
              <p className="text-gray-400 text-center mb-4">
                Python, JavaScript, HTML/CSS - создавай реальные проекты
              </p>
              <div className="flex justify-between text-xs text-gray-500">
            ...
            <div className="bg-dark-700 p-6 rounded-xl border-2 border-neon-pink/20 hover:border-neon-pink/50 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-bold text-center mb-3 text-neon-pink">
                Дизайн
              </h3>
              <p className="text-gray-400 text-center mb-4">
                Photoshop, Figma, Illustrator - создавай крутые дизайны
              </p>
              <div className="flex justify-between text-xs text-gray-500">
            ...
            <div className="bg-dark-700 p-6 rounded-xl border-2 border-neon-purple/20 hover:border-neon-purple/50 transition-all duration-300 transform hover:-translate-y-2 group">
              ...
              <h3 className="text-xl font-bold text-center mb-3 text-neon-purple">
                Рисование
              </h3>
              <p className="text-gray-400 text-center mb-4">
                Digital art, скетчинг, анимация - развивай креативность
              </p>
              <div className="flex justify-between text-xs text-gray-500">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Мы превратили обучение в увлекательную RPG-игру, где ты
                прокачиваешь не виртуального, а реального персонажа — себя!
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Повышай уровень, открывай ачивки и получай награды за
                      реальные успехи в обучении.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Зарабатывай монеты и покупай полезные ресурсы.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2 relative">
              <div className="bg-dark-800 border-2 border-neon-purple/30 rounded-2xl p-6 shadow-xl">
                ...
                <div className="mb-4">
                  <h4 className="font-bold mb-3 text-neon-blue">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-gray-500 hover:text-neon-pink transition"
                >
                ...
                <a
                  href="#"
                  className="text-gray-500 hover:text-neon-red transition"
                >
